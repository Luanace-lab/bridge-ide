...
test.describe('frontend clickpath audit', () => {
  ...
  test('project config page executes safe clickpaths and exports JSON', async ({ page }) => {
    const tmpRoot = `/home/user/Desktop/bridge_frontend_audit_${Date.now()}`;
    ...
    await expect(page.getByText('Projekt-Erstellung ist nur innerhalb von /home/user/Desktop erlaubt.')).toBeVisible();
