...
| Ghost MCP | SEPARATER MCP-SERVER | Existiert als `ghost_mcp_server.py` unter `/home/leo/Desktop/ghost/`. Status: `legacy_custom`, `production_ready: false` laut mcp_catalog.json. 13% implementiert (8/60 ACs). Wird von allen Agents geladen, aber nicht produktionsreif. |
| AASE MCP Tools | SEPARATER MCP-SERVER | Existiert als `aase_mcp.py` unter `/home/leo/Desktop/ACE_SEC/`. Status: `legacy_custom`, `production_ready: false`, `reproducible: false` laut mcp_catalog.json. 4 Tools funktional (aase_api_scan, aase_attack, aase_recon, aase_web_scan), aber nicht in bridge_mcp.py integriert. |
...
```bash
pip install -e /home/leo/Desktop/ACE_SEC/
```
...
- `pip install -e /home/leo/Desktop/ACE_SEC/` in Bridge-Umgebung
...
- ACE_SEC Codebasis: 67.811 LOC, 120+ Module, 12 Domaenen — /home/leo/Desktop/ACE_SEC/
- ACE_SEC Architecture Spec: 8 Core Engines, Agentic-First Design — /home/leo/Desktop/ACE_SEC/ACE_SEC_ARCHITECTURE.md
- ACE_SEC Feasibility: Code-Reuse 70-80% aus ACE Core — /home/leo/Desktop/ACE_SEC/ACE_SEC_FEASIBILITY.md
- AASE Codebase-Analyse: Kai, 2026-03-01 — /home/leo/Desktop/CC/BRIDGE/Archiev/Agent_Homes_Gebuendelt/docs/research/ace_sec_analysis.md
