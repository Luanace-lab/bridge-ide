...
def _render_buddy_operator_guide() -> str:
    return (
        ...
        "- Repo-SoT-Doku: `/home/user/bridge/BRIDGE/Codex_resume-019cdc3e-4534-7f13-9b0b-979a408e9ead/Projekt_Dokumentation`\n"
        "- Architektur/Runtime/API: `/home/user/bridge/BRIDGE/Backend/server.py`\n"
        "- Team-/Agent-Definitionen: `/home/user/bridge/BRIDGE/Backend/team.json`\n"
        "- Frontdoor fuer Buddy: `/home/user/bridge/BRIDGE/Frontend/buddy_landing.html`\n"
        "- Hauptarbeitsflaeche: `/home/user/bridge/BRIDGE/Frontend/chat.html`\n"
        "- Operatives Dashboard: `/home/user/bridge/BRIDGE/Frontend/control_center.html`\n"
        "- Projekt-/Runtime-Setup: `/home/user/bridge/BRIDGE/Frontend/project_config.html`\n\n"
