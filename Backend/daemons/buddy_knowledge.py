...
def _build_buddy_system_sot(sot_path: str, buddy_home: str) -> None:
    ...
    lines = [
        ...
        "### User und Persona",
        "",
        "- Kanonischer User-Scope: `/home/leo/Desktop/CC/BRIDGE/Knowledge/Users/<user_id>/USER.md`",
        ...
        "- Fuer Produktziel und Mindeststandard die Plattformdoku unter `/home/leo/Desktop/CC/Plattformen`.",
