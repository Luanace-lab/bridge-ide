...
def test_sup_01_watcher_kill():
    ...
    if not LIVE_MODE:
        ...
        with patch.object(server, '_pid_alive', return_value=False):
            ...
            test_pid_file = os.path.join("/home/user/bridge/BRIDGE/Backend/pids", "test_watchdog_watcher.pid")
    ...
    # 1. Watcher PID lesen
    watcher_pid_file = "/home/user/bridge/BRIDGE/Backend/pids/watcher.pid"
    try:
...
def test_sup_02_forwarder_kill():
    ...
    if not LIVE_MODE:
        ...
        with patch.object(server, '_pid_alive', return_value=False):
            pid_dir = "/home/user/bridge/BRIDGE/Backend/pids"
...
def test_sup_05a_pid_file_missing_process_running():
    ...
    pid_file = "/home/user/bridge/BRIDGE/Backend/pids/watcher.pid"
