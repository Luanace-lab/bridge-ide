...
## Scope
- `/home/leo/Desktop/CC/BRIDGE/Backend`
...
- Verifiziert wirksam im neuen Live-Code:
  ...
  - `codex` wird ueber `/home/leo/Desktop/CC/BRIDGE/.agent_sessions/codex/AGENTS.md` bewertet und nicht mehr ueber ein fehlendes root-`CLAUDE.md`.
  - `/agents/backend/persistence` liefert die CLI-Workspace-Pfade unter `/home/leo/Desktop/CC/BRIDGE/.agent_sessions/backend/...`.
...
- Verifizierter Gegenbefund im selben Neustartlauf:
  ...
  - `start_agents.py` protokollierte weiterhin Fehlstarts fuer mehrere Auto-Start-Agents (`404` bzw. fehlendes `/home/leo/Desktop/CC/BRIDGE/config/mcp_catalog.json`).
  - `/agents/assi/persistence` fiel weiterhin auf root-/Mischpfade zurueck (`/home/leo/Desktop/CC/BRIDGE/CLAUDE.md`, kein `SOUL.md`, `healthy=false`).
- Schlussfolgerung:
...
- Gleichzeitig verifiziert negativ:
  ...
  - `server.log` zeigt weiterhin fehlendes `/home/leo/Desktop/CC/BRIDGE/config/mcp_catalog.json`.
- Schlussfolgerung:
...
- Negativpfad real verifiziert:
  - Beide realen Claude-Credential-Stores (`/home/leo/.claude/.credentials.json`, `/home/leo/.claude-sub2/.credentials.json`) waren abgelaufen.
...
- Verifiziert ist jetzt:
  ...
  - erfolgreicher kanonischer Startpfad gegen `/home/leo/Desktop/CC/BRIDGE`
...
- Verifiziert auf Disk:
  - [`codex_a .codex/config.toml`](/home/leo/Desktop/CC/BRIDGE/.agent_sessions/codex_a/.codex/config.toml)
  - [`codex_b .codex/config.toml`](/home/leo/Desktop/CC/BRIDGE/.agent_sessions/codex_b/.codex/config.toml)
...
- Verifiziert live:
  - `GET /agents/codex_a` liefert:
    ...
    - `project_root=/home/leo/Desktop/CC/BRIDGE`
    - `instruction_path=/home/leo/Desktop/CC/BRIDGE/.agent_sessions/codex_a/AGENTS.md`
...
- Verifiziert durch Ausfuehrung:
  ...
  - `env CLAUDE_CONFIG_DIR=/home/leo/.claude-sub2 claude -p ok --output-format text` liefert `OK.`
...
- Weiter offen und separat zu behandeln:
  ...
  - `bridge_watcher.py` und `output_forwarder.py` senden im aktuellen Stand `/activity` bzw. `/state/{agent}` noch ohne Auth-Header.
    ...
    - `project_root=/home/leo/Desktop/CC/BRIDGE`
    - `instruction_path=/home/leo/Desktop/CC/BRIDGE/.agent_sessions/codex_b/AGENTS.md`
    - `cli_identity_source=cli_register`
...
- Verifiziert live:
  ...
  - `GET /agents/ordo` lieferte live:
    - `workspace=/home/leo/Desktop/CC/BRIDGE/.agent_sessions/ordo`
    - `cli_identity_source=cli_register`
  - reale Helper-Token-Datei vorhanden:
    - `/home/leo/Desktop/CC/BRIDGE/.agent_sessions/ordo/.bridge/agent_session.json`
    - `agent_id=ordo`
    - `source=bridge_mcp`
...
- Umgesetzter Kern:
  ...
  - Der aktuelle Runtime-Agent `claude` wurde ueber den vorhandenen Produktpfad `PUT /agents/claude/subscription` kanonisch auf `sub2` gelegt; dadurch ist `config_dir=/home/leo/.claude-sub2/` jetzt echte `team.json`-Wahrheit.
- Verifizierte Tests:
...
- Verifiziert live:
  ...
  - historischer Live-Nachtrag vor dem aktuellen Cleanup:
    - `/home/leo/.claude/.credentials.json` und `/home/leo/.claude-sub2/.credentials.json` trugen in diesem Zwischenstand gueltige Token-Expiries
