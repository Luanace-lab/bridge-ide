...
## Scope
Gesamter `/home/leo/Desktop/CC/BRIDGE`-Scope mit Fokus auf Architekturgrenzen, Dokumentationsdrift, Strukturmischung und betriebliche Komplexitaet.
...
- `/home/leo/Desktop/CC/BRIDGE/Backend/logs/server.log`
- `/home/leo/Desktop/CC/BRIDGE/Backend/logs/watcher.log`
- `/home/leo/Desktop/CC/BRIDGE/Backend/logs/output_forwarder.log`
- `/home/leo/Desktop/CC/BRIDGE/Frontend/chat.html`
- `/home/leo/Desktop/CC/BRIDGE/Frontend/control_center.html`
- Root-Struktur von `/home/leo/Desktop/CC/BRIDGE`
...
- Real verifizierter Auth-Befund auf der lokalen HTTP-Flaeche nach dem Read-Surface-Haertungsslice:
  - geschlossen:
    ...
    - `GET /agent/config?project_path=/home/leo/Desktop/CC/BRIDGE&engine=claude` liefert ohne Auth jetzt real `401`
...
- Operatives Restrisiko im aktuellen Live-Betrieb:
  - `ordo` ist im aktuellen Live-Zustand weiter ein echter Startblocker:
    - `GET /agents/ordo` zeigt `status=offline`, `tmux_alive=false`, `config_dir=/home/leo/.claude-sub2`, `subscription_id=""`
  ...
  - historischer Live-Nachtrag vor dem aktuellen Cleanup:
    - `claude` war zwischenzeitlich wieder sauber auf `subscription_id=sub2` und `config_dir=/home/leo/.claude-sub2` gemappt
    - beide lokalen Claude-Profile `/home/leo/.claude` und `/home/leo/.claude-sub2` enthielten dabei nicht abgelaufene `.credentials.json`-Token
