...
Geprueft wurden:
- gesamtes `/home/leo/Desktop/CC/BRIDGE`-Repository
- relevante Konfigurationen und Startpfade
- reale lokale Claude-Config-Verzeichnisse `/home/leo/.claude` und `/home/leo/.claude-sub2`
...
- `/home/leo/.claude/.credentials.json` und `/home/leo/.claude-sub2/.credentials.json` enthalten aktuell nicht abgelaufene Token-Expiries.
