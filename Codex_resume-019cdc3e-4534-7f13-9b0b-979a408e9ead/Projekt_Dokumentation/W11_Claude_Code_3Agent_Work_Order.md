...
- Repository: `/home/user/bridge/BRIDGE`
- Arbeitsprinzipien:
  - evidenzbasiert
  - repository-first
...
- Kanonische SoT-Doku im Repo:
  - `/home/user/bridge/BRIDGE/Codex_resume-019cdc3e-4534-7f13-9b0b-979a408e9ead/Projekt_Dokumentation`

## Pflichtlektüre fuer jeden der 3 Claude-Agents

Jeder Agent muss **vor jeder Codeanalyse** lesen:

1. `/home/user/bridge/BRIDGE/AGENTS.md`
...
- Buddy-Home unter `/home/user/bridge/Buddy`
