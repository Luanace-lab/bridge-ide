...
## Evidenzbasis
- `/home/leo/Desktop/CC/BRIDGE/AGENTS.md`
- `/home/leo/Desktop/CC/Viktor/CLAUDE.md`
- `/home/leo/Desktop/CC/Viktor/Refaktoring_Plan_server_py.md`
- `/home/leo/Desktop/CC/Viktor/CONTEXT_BRIDGE.md`
- `/home/leo/Desktop/CC/Viktor/Slice_00_Freeze.md` bis `/home/leo/Desktop/CC/Viktor/Slice_49_codex_poll_gating.md`
- `/home/leo/Desktop/CC/BRIDGE/Backend/server.py`
- `/home/leo/Desktop/CC/BRIDGE/Backend/handlers/`
- `/home/leo/Desktop/CC/BRIDGE/Backend/daemons/`
- `/home/leo/Desktop/CC/BRIDGE/Backend/tests/`
...
- Operativer persistenter Kontext liegt bis zur Wiederherstellung in:
  - `/home/leo/Desktop/CC/Viktor/CONTEXT_BRIDGE.md`
  - `/home/leo/Desktop/CC/Viktor/Slice_*.md`
...
- Die nach Slice 35 beobachtete Runtime-Drift ist inzwischen real als separater MCP-/Registrierungsfehler eingegrenzt und behoben:
  ...
  - der historische `ordo`-Limitfall ist ebenfalls aufgeloest:
    - `ordo` laeuft jetzt auf `sub1` / `/home/leo/.claude-agent-mobile/`
    - `CLAUDE_CONFIG_DIR=/home/leo/.claude-agent-mobile claude auth status` -> `luan.trade2m@gmail.com`
...
- Live-Probes nach kanonischem Neustart:
  ...
  - `GET /agents/codex_2` -> `instruction_path=/home/leo/Desktop/CC/BRIDGE/.agent_sessions/codex_2/AGENTS.md`, `cli_identity_source=cli_register`
...
- Live-Probes nach kanonischem Neustart:
  ...
  - `GET /health` -> `status=ok`
- Reale `/agent/config`-Proben auf isoliertem Testprojekt `/home/leo/Desktop/CC/BRIDGE/.tmp_slice38_agent_files`:
...
- Live-Probes gegen frisch gestarteten Server:
  ...
  - `GET /memory/status`
  - `POST /memory/migrate`
  - alle real gruen auf isoliertem Testprojekt `/home/leo/Desktop/CC/BRIDGE/.tmp_slice09_memory_project`
...
- Die Projekt-GET-Routen `/projects`, `/projects/open` und `/context` liegen jetzt in `Backend/handlers/projects.py` und sind ueber Direktvertraege, isolierte HTTP-Vertraege, kanonischen Neustart und reale Live-Probes gegen den echten Arbeitsbaum `/home/leo/Desktop/CC/BRIDGE` abgesichert.
...
- Beobachteter Altfehler nach kanonischem Neustart:
  ...
  - `Backend/logs/server.log` zeigt als direkte Ursache: fehlende Datei `/home/leo/Desktop/CC/BRIDGE/config/capability_library.json`
