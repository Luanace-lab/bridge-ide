...
## Scope
`/home/user/bridge/BRIDGE/Backend/server.py`, `Backend/workflow_registry.json`, `Backend/event_subscriptions.json`, n8n-Workflows und die Workflow-UIs in `chat.html` sowie `control_center.html`.

## Evidenzbasis
- `/home/user/bridge/BRIDGE/Backend/server.py`
- `/home/user/bridge/BRIDGE/Backend/workflow_registry.json`
- `/home/user/bridge/BRIDGE/Backend/event_subscriptions.json`
