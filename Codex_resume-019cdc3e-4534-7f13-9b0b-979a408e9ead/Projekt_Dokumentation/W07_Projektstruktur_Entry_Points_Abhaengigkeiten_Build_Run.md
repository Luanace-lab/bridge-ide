...
## Scope
Root von `/home/user/bridge/BRIDGE` sowie `Backend/server.py`, `Backend/runtime_layout.py`, `Backend/bridge_watcher.py`, `Backend/output_forwarder.py`, `Backend/common.py`, `Backend/agent_liveness_supervisor.py`, `Backend/start_platform.sh`, `Backend/stop_platform.sh`, `Backend/restart_wrapper.sh`, `Backend/start_agents.py`, `Backend/config.py`, `Backend/tests/test_process_stability_contract.py`, `Backend/tests/test_output_forwarder_strict_auth_contract.py`, `Backend/tests/test_agent_liveness_supervisor_contract.py`, `Backend/tests/test_packaging_contract.py`, `Backend/tests/test_workflow_bot_contract.py`, `Frontend/chat_workflow_buttons.spec.js`, `bridge_ide/`, `Archiev/bridge_ide/cli.py`, `Archiev/bridge_ide/_backend_path.py`, `Dockerfile`, `docker-compose.yml` und `entrypoint.sh`.

## Evidenzbasis
- `/home/user/bridge/BRIDGE/pyproject.toml`
- `/home/user/bridge/BRIDGE/setup.py`
- `/home/user/bridge/BRIDGE/README.md`
- `/home/user/bridge/BRIDGE/entrypoint.sh`
- `/home/user/bridge/BRIDGE/Dockerfile`
- `/home/user/bridge/BRIDGE/docker-compose.yml`
...
- `/home/user/bridge/BRIDGE/Backend/start_agents.py`
- `/home/user/bridge/BRIDGE/Backend/config.py`
- `/home/user/bridge/BRIDGE/Backend/tests/test_process_stability_contract.py`
- `/home/user/bridge/BRIDGE/Backend/tests/test_output_forwarder_strict_auth_contract.py`
- `/home/user/bridge/BRIDGE/Backend/tests/test_agent_liveness_supervisor_contract.py`
- `/home/user/bridge/BRIDGE/Backend/tests/test_packaging_contract.py`
- `/home/user/bridge/BRIDGE/Backend/tests/test_workflow_bot_contract.py`
- `/home/user/bridge/BRIDGE/Frontend/chat_workflow_buttons.spec.js`
- `/home/user/bridge/BRIDGE/bridge_ide/__init__.py`
- `/home/user/bridge/BRIDGE/bridge_ide/_backend_path.py`
- `/home/user/bridge/BRIDGE/bridge_ide/cli.py`
- `/home/user/bridge/BRIDGE/Archiev/bridge_ide/cli.py`
- `/home/user/bridge/BRIDGE/Archiev/bridge_ide/_backend_path.py`
...
- Im beobachteten Zustand ist `/home/user/bridge/BRIDGE` kein Git-Root.
