...
7. **Owner fragen** — LETZTER Ausweg, nur wenn 1-6 nicht moeglich
...
- Bei Blocker: bridge_send an zustaendigen Agent oder Owner
...
3. CDP → Settings-Aenderung: moeglich, der Owner sieht es
