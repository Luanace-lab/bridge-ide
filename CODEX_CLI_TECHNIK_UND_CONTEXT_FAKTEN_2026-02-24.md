...
Verifiziert:
- CLI-Pfad: `/home/user/.nvm/versions/node/v24.11.1/bin/codex`
...
- Es laufen zwei Codex-Binary-Prozesse (`codex`):
  - einer mit `cwd = /home/user/bridge/BRIDGE` (`pts/8`)
  - einer mit `cwd = /home/user/bridge/Codex` (`pts/9`)
- `acw_stellexa` tmux-Session zeigt:
  - `cwd = /home/user/bridge/Codex`
