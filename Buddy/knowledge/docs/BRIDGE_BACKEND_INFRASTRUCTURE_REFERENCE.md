...
- Scope: `Backend/server.py`, `Backend/bridge_mcp.py`, `Backend/bridge_watcher.py`, `Backend/tmux_manager.py`, `Backend/automation_engine.py`, `Backend/knowledge_engine.py`, `Backend/mcp_catalog.py`
...
- WebSocket-Server: `127.0.0.1:9112` (`server.py`, `WS_PORT = 9112`)
...
- Entry: `ws_handler(websocket)` (`server.py` ~L19949)
...
| `auto-gen-watcher` | `_auto_gen_watcher` | `server.py:20194` |
| `agent-health-checker` | `_agent_health_checker` | `server.py:20198` |
| `health-monitor` | `_health_monitor_loop` | `server.py:20202` |
| `cli-output-monitor` | `_cli_output_monitor_loop` | `server.py:20206` |
| `rate-limit-resume` | `_rate_limit_resume_loop` | `server.py:20210` |
| `v3-cleanup` | `_v3_cleanup_loop` | `server.py:20224` |
| `task-timeout-checker` | `_task_timeout_loop` | `server.py:20235` |
| `heartbeat-prompter` | `_heartbeat_prompt_loop` | `server.py:20335` |
| `distillation-daemon` | `_distillation_daemon_loop` | `server.py:20339` |
| `task-pusher` | `_idle_agent_task_pusher` | `server.py:20410` |
| `auto-assign` | `_idle_watchdog_auto_assign` | `server.py:20494` |
| `buddy-knowledge` | `_buddy_knowledge_loop` | `server.py:20750` |
| `websocket-server` | `run_websocket_server` | `server.py:20754` |
| `restart-wake` | `_delayed_wake` | `server.py:20762` |
| `server-sigterm-shutdown` | `_shutdown_server` | `server.py:20785` |

- Erwarteter Kernsatz: `websocket-server`, `agent-health-checker`, `health-monitor`, `task-timeout-checker`, `heartbeat-prompter`, `distillation-daemon`, `task-pusher`, `auto-assign`, `buddy-knowledge`, `restart-wake`, u.a.
...
- Gefundene Markdown-Dateien im Release-Clone (`./BRIDGE`): 1
  - `CLAUDE.md`
