...
- Relevante Codepfade in `/home/leo/Desktop/CC/BRIDGE/Backend`
...
- `acw_manager`: CWD `/home/leo/Desktop/CC/BRIDGE`, Command `claude`
- `acw_lucy`: CWD `/home/leo/Desktop/CC/Lucy`, Command `claude`
- `acw_nova`: CWD `/home/leo/Desktop/CC/Nova`, Command `claude`
- `acw_viktor`: CWD `/home/leo/Desktop/CC/Viktor`, Command `claude`
- `acw_stellexa`: CWD `/home/leo/Desktop/CC/Codex`, Command `node` (Codex)

Beobachtet (Prozessbaum):
- `acw_stellexa` ist eine echte Codex-CLI-Session (`node` -> `codex` binary)
- `acw_stellexa` hat `python3 /home/leo/Desktop/CC/BRIDGE/Backend/bridge_mcp.py` als Child-Prozess
...
Beobachtet:
- `/home/leo/Desktop/CC/BRIDGE/.agent_sessions/` ist aktuell leer.
- Kein sichtbarer Workspace unter `/home/leo/Desktop/CC/BRIDGE/.agent_sessions/stellexa`.
...
### Codex (`stellexa`)
Beobachtet:
- `/home/leo/Desktop/CC/Codex` enthaelt `AGENTS.md`, `SOUL.md`, `GROW.md`
- keine lokale `.codex/`-Config in `/home/leo/Desktop/CC/Codex/.codex`
- keine lokale `.mcp.json` in `/home/leo/Desktop/CC/Codex/.mcp.json`
- globale Codex-Config vorhanden mit Bridge-MCP:
  - `/home/leo/.codex/config.toml` enthaelt `[mcp_servers.bridge]`
  - `command = "python3"`
  - `args = ["/home/leo/Desktop/CC/BRIDGE/Backend/bridge_mcp.py"]`

### Claude (`manager`, `lucy`, `nova`, `viktor`)
Beobachtet:
- `/home/leo/Desktop/CC/BRIDGE/.claude/settings.local.json` hat explizite `mcp__bridge*`/`mcp__playwright*`-Freigaben und `defaultMode = bypassPermissions`
- `lucy/nova/viktor` haben keine lokalen `.claude/settings.local.json` (in ihren Homes nicht vorhanden)
- gemeinsame MCP-Konfig auf `/home/leo/Desktop/CC/.mcp.json` enthaelt `bridge` und `playwright`
- globale Claude-Config in `/home/leo/.claude/settings.json` vorhanden (breite Permissions, Plugins)
